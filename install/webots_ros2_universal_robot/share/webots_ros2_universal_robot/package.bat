...
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\webots_ros2_universal_robot\hook\pythonpath.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\webots_ros2_universal_robot\hook\ament_prefix_path.bat"
