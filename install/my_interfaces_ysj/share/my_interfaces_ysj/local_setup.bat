...
set "AMENT_ENVIRONMENT_HOOKS[my_interfaces_ysj]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[my_interfaces_ysj] "%AMENT_CURRENT_PREFIX%\share\my_interfaces_ysj\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[my_interfaces_ysj] "%AMENT_CURRENT_PREFIX%\share\my_interfaces_ysj\environment\path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[my_interfaces_ysj] "%AMENT_CURRENT_PREFIX%\share\my_interfaces_ysj\environment\pythonpath.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[my_interfaces_ysj]:;=";"%") do (
    call:call_file %%f
  )
