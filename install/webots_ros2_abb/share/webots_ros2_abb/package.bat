...
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\webots_ros2_abb\hook\pythonpath.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\webots_ros2_abb\hook\ament_prefix_path.bat"
