...
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\webots_ros2_tutorials\hook\pythonpath.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\webots_ros2_tutorials\hook\ament_prefix_path.bat"
