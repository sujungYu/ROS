...
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\test_package_ysj\hook\pythonpath.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\test_package_ysj\hook\ament_prefix_path.bat"
