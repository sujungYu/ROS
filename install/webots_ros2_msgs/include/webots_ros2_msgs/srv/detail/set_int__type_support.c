  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  webots_ros2_msgs__srv__SetInt_Request__init(message_memory);
}

void SetInt_Request__rosidl_typesupport_introspection_c__SetInt_Request_fini_function(void * message_memory)
{
  webots_ros2_msgs__srv__SetInt_Request__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember SetInt_Request__rosidl_typesupport_introspection_c__SetInt_Request_message_member_array[1] = {
  {
    ...
    offsetof(webots_ros2_msgs__srv__SetInt_Request, value),  // bytes offset in struct
    NULL,  // default value
...
static const rosidl_typesupport_introspection_c__MessageMembers SetInt_Request__rosidl_typesupport_introspection_c__SetInt_Request_message_members = {
  ...
  1,  // number of fields
  sizeof(webots_ros2_msgs__srv__SetInt_Request),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, webots_ros2_msgs, srv, SetInt_Request)() {
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  webots_ros2_msgs__srv__SetInt_Response__init(message_memory);
}

void SetInt_Response__rosidl_typesupport_introspection_c__SetInt_Response_fini_function(void * message_memory)
{
  webots_ros2_msgs__srv__SetInt_Response__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember SetInt_Response__rosidl_typesupport_introspection_c__SetInt_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(webots_ros2_msgs__srv__SetInt_Response, success),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers SetInt_Response__rosidl_typesupport_introspection_c__SetInt_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(webots_ros2_msgs__srv__SetInt_Response),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_webots_ros2_msgs
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, webots_ros2_msgs, srv, SetInt_Response)() {
...
static rosidl_typesupport_introspection_c__ServiceMembers webots_ros2_msgs__srv__detail__set_int__rosidl_typesupport_introspection_c__SetInt_service_members = {
  "webots_ros2_msgs__srv",  // service namespace
  "SetInt",  // service name
  // these two fields are initialized below on the first access
  NULL,  // request message
  // webots_ros2_msgs__srv__detail__set_int__rosidl_typesupport_introspection_c__SetInt_Request_message_type_support_handle,
  NULL  // response message
  // webots_ros2_msgs__srv__detail__set_int__rosidl_typesupport_introspection_c__SetInt_Response_message_type_support_handle
};

static rosidl_service_type_support_t webots_ros2_msgs__srv__detail__set_int__rosidl_typesupport_introspection_c__SetInt_service_type_support_handle = {
  0,
  &webots_ros2_msgs__srv__detail__set_int__rosidl_typesupport_introspection_c__SetInt_service_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, webots_ros2_msgs, srv, SetInt)() {
  if (!webots_ros2_msgs__srv__detail__set_int__rosidl_typesupport_introspection_c__SetInt_service_type_support_handle.typesupport_identifier) {
    webots_ros2_msgs__srv__detail__set_int__rosidl_typesupport_introspection_c__SetInt_service_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  rosidl_typesupport_introspection_c__ServiceMembers * service_members =
    (rosidl_typesupport_introspection_c__ServiceMembers *)webots_ros2_msgs__srv__detail__set_int__rosidl_typesupport_introspection_c__SetInt_service_type_support_handle.data;

  if (!service_members->request_members_) {
    service_members->request_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, webots_ros2_msgs, srv, SetInt_Request)()->data;
  }
  if (!service_members->response_members_) {
    service_members->response_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, webots_ros2_msgs, srv, SetInt_Response)()->data;
  }

  return &webots_ros2_msgs__srv__detail__set_int__rosidl_typesupport_introspection_c__SetInt_service_type_support_handle;
}
