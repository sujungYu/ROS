...
#ifndef WEBOTS_ROS2_MSGS__SRV__DETAIL__SET_INT__FUNCTIONS_H_
#define WEBOTS_ROS2_MSGS__SRV__DETAIL__SET_INT__FUNCTIONS_H_
 ...
 * calls
 * webots_ros2_msgs__srv__SetInt_Request__init().
...
/**
 * It calls
 * webots_ros2_msgs__srv__SetInt_Request__fini()
 ...
 * webots_ros2_msgs__srv__SetInt_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * webots_ros2_msgs__srv__SetInt_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * webots_ros2_msgs__srv__SetInt_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_webots_ros2_msgs
...
/**
 * It calls
 * webots_ros2_msgs__srv__SetInt_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_webots_ros2_msgs
...
/**
 * It allocates the memory for the array and calls
 * webots_ros2_msgs__srv__SetInt_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_webots_ros2_msgs
...
/**
 * It calls
 * webots_ros2_msgs__srv__SetInt_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // WEBOTS_ROS2_MSGS__SRV__DETAIL__SET_INT__FUNCTIONS_H_
