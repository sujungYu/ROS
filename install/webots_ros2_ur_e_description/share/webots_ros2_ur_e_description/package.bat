...
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\webots_ros2_ur_e_description\hook\pythonpath.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\webots_ros2_ur_e_description\hook\ament_prefix_path.bat"
