...
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\webots_ros2_tiago\hook\pythonpath.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\webots_ros2_tiago\hook\ament_prefix_path.bat"
