...
#include "webots_ros2_msgs/srv/detail/set_int__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const webots_ros2_msgs::srv::SetInt_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<webots_ros2_msgs::srv::SetInt_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _SetInt_Request__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const webots_ros2_msgs::srv::SetInt_Request *>(
...
{
  return max_serialized_size_SetInt_Request(full_bounded, 0);
}

static message_type_support_callbacks_t _SetInt_Request__callbacks = {
...
static rosidl_message_type_support_t _SetInt_Request__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SetInt_Request__callbacks,
...
{
  return &webots_ros2_msgs::srv::typesupport_fastrtps_cpp::_SetInt_Request__handle;
}
...
{
  auto typed_message =
    static_cast<const webots_ros2_msgs::srv::SetInt_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<webots_ros2_msgs::srv::SetInt_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _SetInt_Response__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const webots_ros2_msgs::srv::SetInt_Response *>(
...
{
  return max_serialized_size_SetInt_Response(full_bounded, 0);
}

static message_type_support_callbacks_t _SetInt_Response__callbacks = {
  "webots_ros2_msgs::srv",
  "SetInt_Response",
...
static rosidl_message_type_support_t _SetInt_Response__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SetInt_Response__callbacks,
  get_message_typesupport_handle_function,
};
...
{
  return &webots_ros2_msgs::srv::typesupport_fastrtps_cpp::_SetInt_Response__handle;
}
...
static service_type_support_callbacks_t _SetInt__callbacks = {
  "webots_ros2_msgs::srv",
  "SetInt",
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, webots_ros2_msgs, srv, SetInt_Request)(),
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, webots_ros2_msgs, srv, SetInt_Response)(),
...
static rosidl_service_type_support_t _SetInt__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SetInt__callbacks,
...
{
  return &webots_ros2_msgs::srv::typesupport_fastrtps_cpp::_SetInt__handle;
}
