...
{
  new (message_memory) webots_ros2_msgs::srv::SetInt_Request(_init);
}

void SetInt_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<webots_ros2_msgs::srv::SetInt_Request *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember SetInt_Request_message_member_array[1] = {
  {
    ...
    offsetof(webots_ros2_msgs::srv::SetInt_Request, value),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers SetInt_Request_message_members = {
  ...
  1,  // number of fields
  sizeof(webots_ros2_msgs::srv::SetInt_Request),
...
{
  return &::webots_ros2_msgs::srv::rosidl_typesupport_introspection_cpp::SetInt_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, webots_ros2_msgs, srv, SetInt_Request)() {
  return &::webots_ros2_msgs::srv::rosidl_typesupport_introspection_cpp::SetInt_Request_message_type_support_handle;
}
...
void SetInt_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) webots_ros2_msgs::srv::SetInt_Response(_init);
}

void SetInt_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<webots_ros2_msgs::srv::SetInt_Response *>(message_memory);
  typed_message->~SetInt_Response();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember SetInt_Response_message_member_array[1] = {
  {
    "success",  // name
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(webots_ros2_msgs::srv::SetInt_Response, success),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers SetInt_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(webots_ros2_msgs::srv::SetInt_Response),
...
{
  return &::webots_ros2_msgs::srv::rosidl_typesupport_introspection_cpp::SetInt_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, webots_ros2_msgs, srv, SetInt_Response)() {
  return &::webots_ros2_msgs::srv::rosidl_typesupport_introspection_cpp::SetInt_Response_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers SetInt_service_members = {
  ...
  // see get_service_type_support_handle<webots_ros2_msgs::srv::SetInt>()
...
get_service_type_support_handle<webots_ros2_msgs::srv::SetInt>()
{
  ...
  auto service_type_support =
    &::webots_ros2_msgs::srv::rosidl_typesupport_introspection_cpp::SetInt_service_type_support_handle;
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, webots_ros2_msgs, srv, SetInt)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<webots_ros2_msgs::srv::SetInt>();
}
