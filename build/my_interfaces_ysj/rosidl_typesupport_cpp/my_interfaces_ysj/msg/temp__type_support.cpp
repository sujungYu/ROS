...
static const _Temp_type_support_symbol_names_t _Temp_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_connext_cpp, my_interfaces_ysj, msg, Temp)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_interfaces_ysj, msg, Temp)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, my_interfaces_ysj, msg, Temp)),
  }
};
...
{
  return &::my_interfaces_ysj::msg::rosidl_typesupport_cpp::Temp_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, my_interfaces_ysj, msg, Temp)() {
  return get_message_type_support_handle<my_interfaces_ysj::msg::Temp>();
}
