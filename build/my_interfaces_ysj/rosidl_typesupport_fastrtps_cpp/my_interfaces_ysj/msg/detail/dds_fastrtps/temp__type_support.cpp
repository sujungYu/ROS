...
#include "my_interfaces_ysj/msg/detail/temp__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const my_interfaces_ysj::msg::Temp *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<my_interfaces_ysj::msg::Temp *>(
    untyped_ros_message);
...
{
  return &my_interfaces_ysj::msg::typesupport_fastrtps_cpp::_Temp__handle;
}
